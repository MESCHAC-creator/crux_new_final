...
class _ProfileScreenState extends State<ProfileScreen> with SingleTickerProviderStateMixin {
  ...
  Future<void> _pickAndUploadPhoto(ImageSource source) async {
    try {
      final picked = await _picker.pickImage(source: source, imageQuality: 80, maxWidth: 512);
  ...
  Future<void> _removePhoto() async {
    ...
    try {
      ...
      await _db.collection('users').doc(uid).set({'photoUrl': null}, SetOptions(merge: true));
      if (mounted) _snack('✅ Photo supprimée');
    } catch (_) {}
  }
        ...
        builder: (ctx, setS) => AlertDialog(
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () async {
                Navigator.pop(ctx);
                await _changePassword(currentCtrl.text, newCtrl.text, lang);
              },
              style: ElevatedButton.styleFrom(
                  backgroundColor: cp.primary,
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12))),
                                  ...
                                  child: _isUploading
                                      ...
                                      : hasPhoto
                                          ? Image.network(user!.photoURL!, fit: BoxFit.cover,
                                              errorBuilder: (_, __, ___) => _initialsCircle(initials, cp))
                                          : _initialsCircle(initials, cp),
                                ),
                              ),
                            ),
                            Positioned(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _GlassCard(isDark: isDark, child: Row(
                      children: [
                      ...
                      if (hasEmailProvider) ...[
                        _ProfileTile(
                          ...
                          trailing: Container(
                            ...
                            child: Text('Actif', style: GoogleFonts.poppins(
                        ...
                        _ProfileTile(
                          ...
                          trailing: Container(
                            ...
                            child: Text('Google', style: GoogleFonts.poppins(
                                color: const Color(0xFF4285F4), fontSize: 11, fontWeight: FontWeight.w600)),
                          ),
                        ),
                    ])),
  ...
  Widget _initialsCircle(String initials, ColorProvider cp) {
    return Container(
      decoration: BoxDecoration(gradient: cp.gradient),
      child: Center(
        child: Text(initials,
...
class _ProfileTile extends StatelessWidget {
  ...
  const _ProfileTile({
    ...
    required this.trailing, required this.isDark, this.onTap,
  });
  @override
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      Text(value, style: GoogleFonts.poppins(
          fontWeight: FontWeight.w800, fontSize: 20, color: isDark ? Colors.white : Colors.black87)),
      const SizedBox(height: 2),
      Text(label, textAlign: TextAlign.center, style: GoogleFonts.poppins(
          fontSize: 10, color: isDark ? Colors.white54 : Colors.black45)),
    ]),
  );
}
