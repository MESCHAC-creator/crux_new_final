                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _GlassCard(
                        isDark: isDark,
                        child: Column(children: [
                          _GlassTile(icon: Icons.info_outline, iconColor: Colors.grey, title: AppTranslations.t('version', localeProvider.locale.languageCode), subtitle: '2.37.0', isDark: isDark, trailing: const SizedBox()),
                          _GlassDivider(isDark: isDark),
