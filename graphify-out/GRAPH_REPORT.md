...
## Corpus Check
- 96 files · ~89,363 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1740 nodes · 962 edges · 1009 communities (83 shown, 926 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.82)
- Token cost: 0 input · 0 output

## Community Hubs (Navigation)
- [[_COMMUNITY_Core Types & WebRTC Primitives|Core Types & WebRTC Primitives]]
- [[_COMMUNITY_Firebase Init & Auth Wrapper|Firebase Init & Auth Wrapper]]
- [[_COMMUNITY_UI Theming & ShareStorage|UI Theming & Share/Storage]]
- [[_COMMUNITY_Localization & Animations|Localization & Animations]]
- [[_COMMUNITY_Video Call Screen UI|Video Call Screen UI]]
- [[_COMMUNITY_Meeting Screen & Auth|Meeting Screen & Auth]]
- [[_COMMUNITY_Android Native & Manifest|Android Native & Manifest]]
- [[_COMMUNITY_Firestore Signaling & Meetings|Firestore Signaling & Meetings]]
- [[_COMMUNITY_Home Screen & Auth State|Home Screen & Auth State]]
- [[_COMMUNITY_Deep Link & Guest Join|Deep Link & Guest Join]]
- [[_COMMUNITY_Foreground Service Notifications|Foreground Service Notifications]]
- [[_COMMUNITY_Deep Link Routing & Web Join|Deep Link Routing & Web Join]]
- [[_COMMUNITY_Profile Screen & Colors|Profile Screen & Colors]]
- [[_COMMUNITY_Localization Delegates|Localization Delegates]]
- [[_COMMUNITY_Whiteboard Elements|Whiteboard Elements]]
- [[_COMMUNITY_App Translations|App Translations]]
- [[_COMMUNITY_Navigation & Bottom Bar|Navigation & Bottom Bar]]
- [[_COMMUNITY_ProDjamo Payment|Pro/Djamo Payment]]
- [[_COMMUNITY_CI & External Agents|CI & External Agents]]
- [[_COMMUNITY_Firestore User Service|Firestore User Service]]
...
1. `CallForegroundService` - 12 edges
2. `Web Join Call Page (/join/index.html)` - 8 edges
3. `_ProfileScreenState` - 7 edges
4. `_VideoCallScreenState` - 6 edges
5. `_PaywallDialogState` - 5 edges
6. `Firebase Project crux-8aa85` - 5 edges
7. `Deep Link Scheme crux://join/{meetingId}` - 5 edges
8. `MainActivity.kt` - 5 edges
9. `_HomeScreenState` - 4 edges
10. `build` - 4 edges

## Surprising Connections (you probably didn't know these)
- `Web Join Call Page (/join/index.html)` --semantically_similar_to--> `VideoCallScreen`  [INFERRED] [semantically similar]
  web/public/join/index.html → CLAUDE.md
- `Firestore webrtc_rooms Collection` --semantically_similar_to--> `WebRTC P2P Signaling via Firestore`  [INFERRED] [semantically similar]
  web/public/join/index.html → CLAUDE.md
- `Web Join Landing Page (index.html)` --references--> `Firebase Project crux-8aa85`  [INFERRED]
  web/public/index.html → CLAUDE.md
- `Web Join Landing Page (index.html)` --references--> `Deep Link Scheme crux://join/{meetingId}`  [INFERRED]
  web/public/index.html → CLAUDE.md
- `Web Join Call Page (/join/index.html)` --references--> `Firestore presence Sub-Collection`  [EXTRACTED]
  web/public/join/index.html → CLAUDE.md
...
- **Authentication Flow** — lib_screens_login_screen_dart, lib_screens_signup_screen_dart, lib_providers_auth_provider_dart, lib_services_auth_service_dart [EXTRACTED 0.95]
- **WebRTC Signaling Flow** — crux_new_final_webrtc_p2p, crux_new_final_webrtc_rooms, crux_new_final_firestore_meetings, crux_new_final_ice_config [EXTRACTED 0.95]
- **Provider State Management Layer** — lib_providers_auth_provider_dart, lib_providers_meeting_provider_dart, lib_providers_theme_provider_dart, lib_providers_locale_provider_dart, lib_providers_color_provider_dart [EXTRACTED 0.95]

## Communities (1009 total, 926 thin omitted)

### Community 0 - "Core Types & WebRTC Primitives"
Cohesion: 0.01
Nodes (371): ../constants/app_constants.dart, dart:async, dart:math, DateTime?, MediaStream?, meeting_report_screen.dart, ../models/meeting_report_model.dart, Offset? (+363 more)

### Community 1 - "Firebase Init & Auth Wrapper"
Cohesion: 0.04
Nodes (49): bool?, class, firebase_options.dart, _authStream, blockReason, createState, _flutterUnsupportedLocales, _initDeepLinks (+41 more)

### Community 2 - "UI Theming & Share/Storage"
Cohesion: 0.04
Nodes (48): Color, dart:io, Map, package:flutter/services.dart, package:share_plus/share_plus.dart, QuerySnapshot, _authService, build (+40 more)

### Community 3 - "Localization & Animations"
Cohesion: 0.04
Nodes (46): Animation, AnimationController, dart:convert, dart:ui, ../l10n/app_translations.dart, package:image_picker/image_picker.dart, package:path_provider/path_provider.dart, _animCtrl (+38 more)

### Community 4 - "Video Call Screen UI"
Cohesion: 0.04
...
### Community 5 - "Meeting Screen & Auth"
Cohesion: 0.06
Nodes (34): IconData, meeting_screen.dart, package:firebase_auth/firebase_auth.dart, package:flutter/material.dart, package:google_fonts/google_fonts.dart, build, _buildForm, _buildNotFound (+26 more)

### Community 6 - "Android Native & Manifest"
Cohesion: 0.09
Nodes (28): CallForegroundService.kt, MainActivity.kt, BroadcastReceiver STOP_SCREEN_SHARE_FROM_NOTIFICATION, Deep Link Scheme crux://join/{meetingId}, Device Security Gate, Firebase Project crux-8aa85, Firestore chat Sub-Collection, Firestore meetings Collection (+20 more)

### Community 7 - "Firestore Signaling & Meetings"
Cohesion: 0.08
Nodes (23): FirebaseFirestore, ../models/meeting_model.dart, package:cloud_firestore/cloud_firestore.dart, package:logger/logger.dart, package:uuid/uuid.dart, addCoHost, addParticipant, createMeeting (+15 more)

### Community 8 - "Home Screen & Auth State"
Cohesion: 0.13
Nodes (23): AuthWrapper, _AuthWrapperState, HomeScreen, _HomeScreenState, _LiveBadge, _LiveBadgeState, _OfferingSheet, _OfferingSheetState (+15 more)

### Community 9 - "Deep Link & Guest Join"
Cohesion: 0.11
Nodes (19): _DeviceBlockedApp, MyApp, _Field, _MeetingCard, _QuickAction, _Badge, _BottomSheetTile, _GlassCard (+11 more)

### Community 10 - "Foreground Service Notifications"
Cohesion: 0.19
Nodes (6): CallForegroundService, IBinder, Int, Intent, Notification, Service

### Community 11 - "Deep Link Routing & Web Join"
Cohesion: 0.25
Nodes (8): build, _handleDeepLink, _joinMeetingAsAuthenticatedUser, MaterialPageRoute, _buildMeetingsTab, _buildRecentMeetings, _createMeeting, _joinById

### Community 12 - "Profile Screen & Colors"
Cohesion: 0.47
Nodes (6): ColorProvider, build, ProfileScreen, _ProfileScreenState, _showPhotoOptions, ThemeProvider

### Community 13 - "Localization Delegates"
Cohesion: 0.40
...
### Community 14 - "Whiteboard Elements"
Cohesion: 0.50
Nodes (4): _WbElement, _WbShape, _WbStroke, _WbText

### Community 16 - "Navigation & Bottom Bar"
Cohesion: 0.67
Nodes (3): Route /profile, _buildBottomNav, _buildTopBar

## Knowledge Gaps
- **1335 isolated node(s):** `GeneratedPluginRegistrant`, `FlutterEngine`, `IBinder`, `Int`, `Notification` (+1330 more)
...
- **Why does `_VideoCallScreenState` connect `Home Screen & Auth State` to `Core Types & WebRTC Primitives`, `Video Call Screen UI`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `_FallbackMaterialLocalizationsDelegate` connect `Localization Delegates` to `Firebase Init & Auth Wrapper`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `_PaywallDialogState` connect `Home Screen & Auth State` to `Core Types & WebRTC Primitives`, `Video Call Screen UI`?**
  _High betweenness centrality (0.001) - this node is a cross-community bridge._
- **What connects `GeneratedPluginRegistrant`, `FlutterEngine`, `IBinder` to the rest of the system?**
  _1338 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Core Types & WebRTC Primitives` be split into smaller, more focused modules?**
  _Cohesion score 0.005376344086021506 - nodes in this community are weakly interconnected._
- **Should `Firebase Init & Auth Wrapper` be split into smaller, more focused modules?**
  _Cohesion score 0.04 - nodes in this community are weakly interconnected._
- **Should `UI Theming & Share/Storage` be split into smaller, more focused modules?**
