...
class NotificationService {
  ...
  static const List<Map<String, String>> _reminderMessages = [
    {
      ...
      'body':
          'Lancez une réunion CRUX et restez connecté avec vos collaborateurs.',
    },
    {
      'title': '🎯 Productivité au rendez-vous ?',
      'body': 'Planifiez votre prochaine réunion CRUX pour rester efficace.',
    },
    {
      'title': '✨ CRUX Pro disponible',
      'body':
          'Réunions illimitées pour 100 000 FCFA/mois. Passez à Pro dès maintenant !',
    },
    {
      'title': '📞 Quelqu\'un veut vous joindre ?',
      'body': 'Ouvrez CRUX pour voir vos réunions planifiées.',
    },
    {
      'title': '🚀 Nouveau dans CRUX',
      'body':
          'Tableau collaboratif, sous-titres et filtres caméra disponibles dans votre réunion.',
    },
    {
      'title': '🔒 Appels sécurisés E2E',
      'body':
          'Toutes vos communications sont chiffrées de bout en bout avec CRUX.',
    },
    {
      'title': '⏱️ 30 min gratuites chaque jour',
      'body':
          'Profitez de vos 30 minutes offertes ou passez à Pro pour des réunions illimitées.',
    },
    {
      'title': '🌍 CRUX à votre service',
      'body': 'Vidéoconférence premium depuis n\'importe où dans le monde.',
    },
  ];
  ...
  Future<void> notifyProUpgradeReminder({
    ...
    await showImmediate(
      ...
      body:
          'Passez à CRUX Pro pour des réunions illimitées — 100 000 FCFA/mois',
      id: 51,
    );
  }
